...
public class Game {
    ...
    private static MoveStatus moveStatus =  MoveStatus.OPP_TURN;
    
    private static GameStatus status = GameStatus.SETTING_UP;
    private static PieceColor turn  = PieceColor.RED;
    private static ClientBoard board = new ClientBoard();
